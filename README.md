...
it does not guarantee that it will be done in one function call. I tracked the number of bytes sent succesfully, and continued sending until the amount sent
was equal to the expected length of the data. This required careful buffer management and ensuring each subsequent send operation started from the
